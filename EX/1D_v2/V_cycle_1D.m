function e_h = V_cycle_1D(r_h, nu1, nu2, A_vec,P_vec,tol, lvl, max_lvl)
%V-Cycle function,
...
%the equation Ae = r
    if lvl == max_lvl
        ...
        r_2h = (P_vec{lvl+1}.' * (r_h - A_vec{lvl}*e_h))/4;
        e_2h = V_cycle_1D(r_2h, nu1,nu2,A_vec,P_vec,tol,lvl+1,max_lvl);
        
        e_h = e_h + (P_vec{lvl + 1} * e_2h)/2;
